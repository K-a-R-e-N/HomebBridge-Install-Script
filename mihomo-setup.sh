...
# Настройка мягкой палитры — СТРОГО БЕЗ косых черт перед долларами (ИСПРАВЛЕНО)
cyan=$(tput setaf 6)
green=$(tput setaf 2)
amber=$(tput setaf 3)
dim=$(tput setaf 8)
...
# 3. Настройка системной фоновой службы (Чистые системные переменные БЕЗ экранирования слэшами)
