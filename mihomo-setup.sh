...
# Настройка мягкой цветовой палитры (убран едкий красный)
cyan=$(tput setaf 6)
green=$(tput setaf 2)
amber=$(tput setaf 3)
dim=$(tput setaf 8)
...
# 1. Скачивание бинарного ядра Mihomo с GitHub в тихом режиме
...
# 2. Красивая и чистая инструкция для вывода в терминал
...
echo -e "         оранжевую кнопку ${amber}AWG 2.0${reset} или ${amber}MASQUE${reset}."
echo -e "\n  ${amber}ШАГ 3:${reset} Полностью скопируйте весь открывшийся текст."
echo -e "\n  ${amber}ШАГ 4:${reset} Сейчас откроется редактор. Вставьте текст,"
...
# Все технические эхо-сообщения убраны в тихий режим
...
# 4. Настройка системной фоновой службы юнита Systemd
